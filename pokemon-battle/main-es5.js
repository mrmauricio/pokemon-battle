...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PokemonCardComponent = /** @class */ (function () {
                ...
                PokemonCardComponent.prototype.ngOnInit = function () {
                    this.trophyArray = Array(this.trophyAmount).keys().slice().map(function (id) { return id + 1; });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BattleComponent = /** @class */ (function () {
                function BattleComponent(router, trophyService) {
                    this.router = router;
                ...
                BattleComponent.prototype.getFightersData = function () {
                ...
                BattleComponent.prototype.setInitialState = function () {
                    this.battlePhase = 1;
                ...
                // BATTLE FUNCTIONS             //
                // ---------------------------- //
                BattleComponent.prototype.handleMoveSelect = function (playerMove) {
                    var enemyMove = this.handleEnemyMove();
                    // start battle after player and enemy selected their moves
                    this.enterBattlePhase(playerMove, enemyMove);
                };
                BattleComponent.prototype.handleEnemyMove = function () {
                    var randomMove = this.enemyPokemon.moves[Math.floor(Math.random() * this.enemyPokemon.moves.length)];
                    return randomMove;
                };
                BattleComponent.prototype.enterBattlePhase = function (playerMove, enemyMove) {
                    var _this = this;
                    var firstAttacker, firstAttackerMove, secondAttacker, secondAttackerMove;
                    this.battlePhase = 3;
                    ...
                    setTimeout(function () {
                        ...
                        if (secondAttacker.status.isAlive) {
                            _this.startAttack(secondAttacker, secondAttackerMove, firstAttacker);
                            setTimeout(function () {
                ...
                BattleComponent.prototype.startAttack = function (attacker, attackerMove, defender) {
                    var _this = this;
                    attacker.status.startAttack = true;
                    // check selected move effectiveness on target
                    var attackerMoveEffectiveness = this.calculateTypeEffectiveness(attackerMove, defender);
                    ...
                    var appliedDamage = defender.status.currentHp - attacker.status.damageDealt;
                    if (appliedDamage <= 0) {
                        defender.status.currentHp = 0;
                        defender.status.isAlive = false;
                        setTimeout(function () {
                            _this.handleBattleEnd(attacker);
                        }, this.waitTime);
                    }
                    else {
                ...
                BattleComponent.prototype.handleBattleEnd = function (winner) {
                ...
                // ---------------------------- //
                BattleComponent.prototype.calculatePercentage = function (pokemon) {
                    var remainingHp = (100 * pokemon.status.currentHp) / pokemon.stats.hp;
                ...
                BattleComponent.prototype.calculateDamage = function (attacker, defender, move) {
                    var stabMultiplier = 1;
                    if (attacker.types.find(function (type) { return type === move.type; })) {
                        stabMultiplier = 1.25;
                    }
                    var typeMultiplier = this.calculateTypeEffectiveness(move, defender);
                    var damage = Math.round(0.75 *
                        move.power *
                ...
                BattleComponent.prototype.calculateTypeEffectiveness = function (move, defender) {
                    return defender.types.reduce(function (acc, type) {
                ...
                //  DISPLAY FUNCTIONS       //
                // ---------------------------- //
                BattleComponent.prototype.handleOptionSelect = function (id) {
                    var _this = this;
                    switch (id) {
                        // fight
                        case 1:
                ...
                BattleComponent.prototype.getBattleInfoText = function (id, pokemonName, moveName, effectiveness) {
                    if (pokemonName === void 0) { pokemonName = null; }
                    if (moveName === void 0) { moveName = null; }
                    if (effectiveness === void 0) { effectiveness = 1; }
                    var battleInfo = [
                        { id: 0, name: "" },
                    ...
                    function getInfoName(id) {
                        return battleInfo.find(function (info) { return info.id === id; }).name;
                    }
                    var info = getInfoName(id);
                ...
                BattleComponent.prototype.playAudio = function () {
                ...
                BattleComponent.prototype.formatPokemonData = function (pokemon) {
                    var _this = this;
                    return {
                        id: pokemon.id,
                        ...
                        moves: pokemon.moves.map(function (move) {
                            move.name = _this.capitalizeFirstLetter(move.name);
                            return move;
                        }),
                        stats: pokemon.stats,
                        status: {
                ...
                BattleComponent.prototype.capitalizeFirstLetter = function (str) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MainComponent = /** @class */ (function () {
                function MainComponent(pokemonService, router, trophyService) {
                    var _this = this;
                    ...
                    this.pokedexList = Array(12).keys().slice().map(function (id) { return id + 1; });
                    this.buttons = [
                        {
                            id: 1,
                            name: "Load more",
                            function: function (sectionId) {
                                _this.handlePokedexLoad(sectionId);
                            },
                        ...
                        },
                        {
                            ...
                            name: "Pick Random",
                            function: function (sectionId) {
                                _this.handleRandomSelection(sectionId, false);
                            },
                        ...
                        },
                        {
                            ...
                            name: "Pick Random",
                            function: function (sectionId) {
                                _this.handleRandomSelection(sectionId, true);
                            },
                            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_3__["faQuestion"]
                        }
                    ];
                ...
                MainComponent.prototype.fetchPokemonByIdList = function (idList, sectionId, shouldReturn) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var section, data, e_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, this.pokemonService.getPokemonPreviewByIdList(idList)];
                                case 2:
                                    data = _a.sent();
                ...
                MainComponent.prototype.handlePokedexLoad = function (sectionId) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var section, lastPokemonId, newPokedexList, data;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    section = this.getSectionById(sectionId);
                                    section.buttonList.isLoading = true;
                                    lastPokemonId = section.pokemonList[section.pokemonList.length - 1].id;
                                    newPokedexList = Array(12).keys().slice().map(
                                    // plus 1 because it starts on 0
                                    function (id) { return id + lastPokemonId + 1; });
                                    return [4 /*yield*/, this.fetchPokemonByIdList(newPokedexList, sectionId, true)];
                                case 1:
                                    data = _a.sent();
                ...
                MainComponent.prototype.handleRandomSelection = function (sectionId, onlyFighters) {
                    var randomPokemonId;
                    if (onlyFighters) {
                        var section = this.getSectionById(sectionId);
                        var idList = section.pokemonList.map(function (pokemon) { return pokemon.id; });
                ...
                MainComponent.prototype.handleTrophies = function () {
                    this.trophyList = this.trophyService.getTrophyList();
                    if (!this.trophyList) {
                        this.trophyList = this.trophyService.setInitialTrophyList();
                    }
                };
                MainComponent.prototype.getButtonById = function (id) {
                    return this.buttons.find(function (button) { return button.id === id; });
                };
                MainComponent.prototype.getSectionById = function (id) {
                    return this.sections.find(function (section) { return section.id === id; });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotFoundComponent = /** @class */ (function () {
                ...
                NotFoundComponent.prototype.redirectHome = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PokemonComponent = /** @class */ (function () {
                function PokemonComponent(route, pokemonService, router, trophyService) {
                    this.route = route;
                    this.pokemonService = pokemonService;
                    this.router = router;
                    this.trophyService = trophyService;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.handleTrophies();
                                    this.checkFighterId();
                                    return [4 /*yield*/, this.getPokemonData()];
                                case 1:
                                    _a.sent();
                                    if (this.isFighter) {
                ...
                PokemonComponent.prototype.getPokemonData = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, e_2;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 1:
                                    _b.trys.push([1, 3, , 4]);
                                    _a = this;
                                    return [4 /*yield*/, this.pokemonService.getPokemonDataById(this.id, this.isFighter)];
                                case 2:
                                    _a.pokemon = _b.sent();
                ...
                PokemonComponent.prototype.getFighterIndex = function () {
                    var _this = this;
                    // get current pokemon's index on fighters array
                    this.fighterIndex = this.fightersIdList.findIndex(function (id) { return id === _this.id; });
                };
                PokemonComponent.prototype.checkFighterId = function () {
                    var _this = this;
                    // check if current pokemon is a fighter
                    this.isFighter = Boolean(this.fightersIdList.find(function (id) { return id === _this.id; }));
                };
                PokemonComponent.prototype.checkMoveType = function () {
                    var _this = this;
                    // check moves with same type attack bonus
                    this.isMoveStab = this.pokemon.moves.map(function (move) { return Boolean(_this.pokemon.types.find(function (type) { return type === move.type; })); });
                };
                PokemonComponent.prototype.startBattle = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var idList, randomPokemonId, enemyPokemon;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    idList = _utils_fightersIdList__WEBPACK_IMPORTED_MODULE_6__["fightersIdList"].filter(function (id) { return id !== _this.id; });
                                    randomPokemonId = idList[Math.floor(Math.random() * idList.length)];
                                    return [4 /*yield*/, this.pokemonService.getPokemonDataById(randomPokemonId, true)];
                                case 1:
                ...
                PokemonComponent.prototype.handleTrophies = function () {
                    // get trophies from local storage
                    this.trophyList = this.trophyService.getTrophyList();
                    if (!this.trophyList) {
                        this.trophyList = this.trophyService.setInitialTrophyList();
                    }
                    this.trophyArray = Array(6).keys().slice().map(function (id) { return id + 1; });
                };
                PokemonComponent.prototype.configSameComponentNavigation = function () {
                    var _this = this;
                ...
                PokemonComponent.prototype.ngOnDestroy = function () {
                    // cancel subscription
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PokemonService = /** @class */ (function () {
                ...
                // GET POKEMON PREVIEW          //
                // ---------------------------- //
                PokemonService.prototype.getPokemonPreviewByIdList = function (idArray) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var pokeArray;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, Promise.all(idArray.map(function (id) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.getPokemonPreviewById(id)];
                                            case 1: return [2 /*return*/, _a.sent()];
                                        }
                                    }); }); }))];
                                case 1:
                                    pokeArray = _a.sent();
                                    return [2 /*return*/, pokeArray];
                            }
                        });
                    });
                };
                PokemonService.prototype.getPokemonPreviewById = function (id) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var data, pokemonPreview;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    pokemonPreview = {
                                        ...
                                        name: data.name,
                                        types: data.types.map(function (t) { return t.type.name; }).reverse()
                                    };
                                    //console.log(pokemonPreview);
                                    return [2 /*return*/, pokemonPreview];
                            }
                        });
                    });
                };
                ...
                // ---------------------------- //
                PokemonService.prototype.getPokemonDataById = function (id, isFighter) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var data, statArray, moveArray, movesId, pokemon;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.http
                                        .get(this.baseUrl + "/pokemon/" + id)
                                ...
                                case 1:
                                    data = _a.sent();
                                    moveArray = [];
                                    if (!isFighter) return [3 /*break*/, 3];
                                    // set pokemon stats
                                    statArray = this.formatStats(data.stats);
                                    movesId = _utils_movesIdList__WEBPACK_IMPORTED_MODULE_3__["movesIdList"].find(function (item) { return item.pokemonId === id; }).movesId;
                                    return [4 /*yield*/, this.getMoveByIdList(movesId)];
                                case 2:
                                    moveArray = _a.sent();
                                    _a.label = 3;
                                case 3:
                ...
                PokemonService.prototype.getMoveByIdList = function (idArray) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var moveArray;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, Promise.all(idArray.map(function (id) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.getMoveById(id)];
                                            case 1: return [2 /*return*/, _a.sent()];
                                        }
                                    }); }); }))];
                                case 1:
                                    moveArray = _a.sent();
                                    return [2 /*return*/, moveArray];
                            }
                        });
                    });
                };
                PokemonService.prototype.getMoveById = function (id) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var data, text, move;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    data = _a.sent();
                                    text = data.flavor_text_entries.find(function (item) { return item.language.name === "en"; });
                                    move = {
                ...
                PokemonService.prototype.formatStats = function (stats) {
                    // creating a object with stat name as property
                    var statArray = stats.reduce(function (newObj, s) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TrophyService = /** @class */ (function () {
                function TrophyService() {
                }
                // ---------------------------- //
                // HANDLE POKEMON TROPHIES      //
                // ---------------------------- //
                TrophyService.prototype.getTrophyList = function () {
                    return JSON.parse(localStorage.getItem("trophyList"));
                };
                TrophyService.prototype.setTrophyList = function (newTrophyList) {
                    localStorage.setItem("trophyList", JSON.stringify(newTrophyList));
                };
                TrophyService.prototype.setInitialTrophyList = function () {
                    // creating an object with fighterId as property
                    var initialTrophies = _utils_fightersIdList__WEBPACK_IMPORTED_MODULE_2__["fightersIdList"].reduce(function (newObj, id) {
                        newObj[id] = 0;
                        return newObj;
                    }, {});
                ...
                TrophyService.prototype.addTrophyById = function (id) {
                    var newTrophyList = this.getTrophyList();
